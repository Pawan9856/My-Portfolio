    ...
    <div className="bg-mySecondaryColor/90 text-slate-200 backdrop-blur-lg sticky top-0 z-50 w-full py-3  flex justify-between px-10 ">
      <Link className="flex justify-center items-center gap-3" href="/">
        <Avatar className="w-12 h-12 ">
          <AvatarImage src="/profile-pic.jpg" alt="@shadcn" />
          <AvatarFallback className="bg-myPrimaryColor text-mySecondaryColor text-3xl font-semibold">
            P
          </AvatarFallback>
        </Avatar>
        <span className="text-sm sm:text-lg font-semibold hover:text-myPrimaryColor cursor-pointer transition-all duration-300">
          PAWAN PALIWAL
        </span>
      </Link>
